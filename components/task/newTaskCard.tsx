...
export default function NewTaskCard({ status, board }: { status: InferInsertModel<typeof taskStatuses>, board: InferInsertModel<typeof boards> }) {
    ...
    const handleClick = () => {
        ...
        console.log({ ...task, statusId: status.id!, boardId: board.id! });
